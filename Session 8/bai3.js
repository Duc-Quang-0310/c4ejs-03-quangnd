...
const quoteAu = document.getElementById('quoteAuthor');
...
function reloadQuote (){
    ...
    quoteApp.textContent = quoteData[randomIndex].quoteText;
    quoteAu.textContent = quoteData[randomIndex].quoteAuthor;
}

reloadButton.addEventListener('click', reloadQuote );
